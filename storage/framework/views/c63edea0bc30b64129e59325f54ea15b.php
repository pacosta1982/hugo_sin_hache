...
<head>
    ...
    <title><?php echo e(config('app.name', 'UGo')); ?> - <?php echo $__env->yieldContent('title', 'Sistema de Puntos'); ?></title>
        ...
        <nav class="bg-white shadow-soft border-b border-gray-100 sticky top-0 z-40">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center hover:opacity-90 transition-opacity">
                                <img src="<?php echo e(asset('logo.svg')); ?>" alt="UGo Logo" class="h-10 w-auto">
                            </a>
                        </div>
                        ...
                        <div class="hidden md:ml-8 md:flex md:space-x-8">
                            ...
                            <a href="<?php echo e(route('favorites.index')); ?>" 
                               class="nav-link <?php echo e(request()->routeIs('favorites.*') ? 'active' : ''); ?>">
                                Favoritos
                            </a>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div class="hidden md:flex items-center space-x-2 bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-2 rounded-full border border-blue-100 shadow-sm">
                                ...
                                <span class="text-sm font-semibold text-blue-900">
                                    <?php echo e(number_format(auth()->user()->puntos_totales ?? 0)); ?>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" 
                                ...
                                <div class="w-9 h-9 bg-gradient-blue rounded-full flex items-center justify-center ring-2 ring-white shadow-sm">
                                    <span class="text-white text-sm font-semibold">
                                        <?php echo e(auth()->user() ? strtoupper(substr(auth()->user()->nombre, 0, 1)) : 'U'); ?>

                                    </span>
                                </div>
                                <div class="hidden md:block text-left">
                                    <div class="text-sm font-semibold text-gray-900">
                                        <?php echo e(auth()->user()?->nombre ?? 'Usuario'); ?>

                                    </div>
                                    <div class="text-xs text-gray-500">
                                        <?php echo e(auth()->user()?->rol_usuario ?? 'Empleado'); ?>
                            ...
                            <div x-show="open" 
                                ...
                                <div class="px-4 py-3 border-b border-gray-100">
                                    <div class="text-sm font-semibold text-gray-900"><?php echo e(auth()->user()?->nombre ?? 'Usuario'); ?></div>
                                    <div class="text-xs text-gray-500 truncate"><?php echo e(auth()->user()?->email ?? ''); ?></div>
                                </div>
                                
                                
                                <div class="py-1">
                                    <a href="<?php echo e(route('profile')); ?>" class="dropdown-item flex items-center">
                                        <svg class="w-4 h-4 mr-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                        </svg>
                                        Mi Perfil
                                    </a>
                                    <a href="<?php echo e(route('orders.history')); ?>" class="dropdown-item flex items-center">
                                        <svg class="w-4 h-4 mr-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div class="md:hidden px-4 py-2 border-t border-gray-100 mt-1">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="text-sm font-bold text-teal-600"><?php echo e(number_format(auth()->user()->puntos_totales ?? 0)); ?></span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="mobile-menu hidden md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-50">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>">
                        Productos
                    </a>
                    <a href="<?php echo e(route('favorites.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('favorites.*') ? 'active' : ''); ?>">
                        Favoritos
                    </a>
                    <?php if(auth()->user()?->is_admin ?? false): ?>
                        <a href="<?php echo e(route('admin.orders')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>">
                            Administración
                        </a>
                    <?php endif; ?>
                </div>
...
</html><?php /**PATH C:\Users\User\sheets-backend\ugo-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>