    ...
    <div id="dashboard-content" class="hidden">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">
                ¡Hola, <span id="employee-name"><?php echo e($employee ? $employee->nombre : ''); ?></span>!
            </h1>
            ...
            <div class="card-body">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($stats['total_points'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($stats['redeemed_points'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('orders.history')); ?>" class="text-sm text-teal-600 hover:text-teal-700">
                            Ver todo
                        </a>
                    </div>
                </div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($recentOrders->count() > 0): ?>
                        <div class="flow-root">
                            <ul role="list" class="-mb-8">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                            ...
                                            <div class="relative flex space-x-3">
                                                <div>
                                                    <span class="h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white
                                                        <?php echo e($order->estado === 'pending' ? 'bg-yellow-500' : ''); ?>

                                                        <?php echo e($order->estado === 'processing' ? 'bg-teal-500' : ''); ?>

                                                        <?php echo e($order->estado === 'completed' ? 'bg-green-500' : ''); ?>

                                                        <?php echo e($order->estado === 'cancelled' ? 'bg-red-500' : ''); ?>">
                                                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                ...
                                                <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                                    <div>
                                                        <p class="text-sm text-gray-500">
                                                            Canjeaste <span class="font-medium text-gray-900"><?php echo e($order->producto_nombre); ?></span>
                                                        </p>
                                                        <p class="text-xs text-gray-400">
                                                            <?php echo e($order->puntos_utilizados); ?> puntos utilizados
                                                        </p>
                                                    </div>
                                                    <div class="text-right text-sm whitespace-nowrap text-gray-500">
                                                        <time datetime="<?php echo e($order->fecha->format('Y-m-d')); ?>">
                                                            <?php echo e($order->fecha->diffForHumans()); ?>

                                                        </time>
                                                        <div class="mt-1">
                                                            <span class="status-badge 
                                                                <?php echo e($order->estado === 'pending' ? 'status-pending' : ''); ?>

                                                                <?php echo e($order->estado === 'processing' ? 'status-processing' : ''); ?>

                                                                <?php echo e($order->estado === 'completed' ? 'status-completed' : ''); ?>

                                                                <?php echo e($order->estado === 'cancelled' ? 'status-cancelled' : ''); ?>">
                                                                <?php echo e($order->estado_display); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('products.index')); ?>" class="text-sm text-teal-600 hover:text-teal-700">
                            Ver todos
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <!--[if BLOCK]><![endif]--><?php if($featuredProducts->count() > 0): ?>
                        <div class="space-y-4">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $featuredProducts->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors"
                                     wire:click="redirectToProduct(<?php echo e($product->id); ?>)">
                                    <div class="flex-shrink-0">
                                    ...
                                    <div class="flex-shrink-0 text-right">
                                        <p class="text-sm font-bold text-teal-600">
                                            <?php echo e(number_format($product->costo_puntos)); ?> pts
                                        </p>
                        ...
                        <?php if($featuredProducts->count() > 4): ?>
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                <a href="<?php echo e(route('products.index')); ?>" class="w-full btn-secondary text-center">
                                    Ver <?php echo e($featuredProducts->count() - 4); ?> productos más
                                </a>
                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <?php else: ?>
            ...
            try {
                ...
                if (response && response.employee) {
                    ...
                    if (typeof Livewire !== 'undefined') {
                        ...
                        await Livewire.find('<?php echo e($_instance->getId()); ?>').call('loadDashboardData', response.employee);
...
</div><?php /**PATH C:\Users\User\sheets-backend\ugo-laravel\resources\views/livewire/dashboard.blade.php ENDPATH**/ ?>